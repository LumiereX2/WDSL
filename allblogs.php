  ...
  <section id="all-blogs-section">
    ...
    <div class="continent">
      ...
      <div class="country">
        ...
        <div class="blog-list">
          <div class="blog-card">
            <img src="/WDSL/Assets/Pictures/paris-tn.jpg" alt="baguio" class="blog-image">
            <a href="/WDSL/Blogs/FR_Paris.php">
              <h3 class="blog-title">Paris: City of Lights</h3>
            </a>
          </div>
      </div>
      ...
      <div class="country">
        ...
        <div class="blog-list">
          <div class="blog-card">
            <img src="/WDSL/Assets/Pictures/rome-tn.jpg" alt="baguio" class="blog-image">
            <a href="/WDSL/Blogs/IT_Rome.php">
              <h3 class="blog-title">Rome: The Eternal City</h3>
            </a>
          </div>

          <div class="blog-card">
            <img src="/WDSL/Assets/Pictures/venice-tn.jpg" alt="baguio" class="blog-image">
            <a href="/WDSL/Blogs/IT_Venice.php">
              <h3 class="blog-title">Venice: The City of canals</h3>
            </a>
          </div>
